    ...
    return (
        <article className="etapa">
            <section className="fundoAzul">
                <nav>
                    <img src={setaAtrasBranca} alt="" id="seta" />
                    <h2 id="tutorial">Etapa 0</h2>
                </nav>
                <div className="principal">
                    <h2 id="titulo">1. Workshop</h2>
                    <p id="texto1">Realização de um pequano workshop, dinamizado pelo professor (gestor do projeto), com o intuito de:</p>
                    <ul id="texto2">
                        <li id="bulletpoint">partilhar princípios orientadores sobre características deste modelo de mentoria entre pares e as funções esperadas de um mentor, neste âmbito;</li>
            ...
            <section>
                <div className="principal">
                    ...
                    <p id="texto1">Criar uma equipa de mentores na plataforma:</p>
                    <ul id="texto2">
                        <li id="bulletpoint">depois de criar uma equipa de mentores, poderá associar à mesma um novo projeto. Assim, no espaço dedicado a cada nova equipa aparecerão listados todos os projetos em que a mesma já terá estado envolvida;</li>
